...
function Cart({ setPage }) {
    ...
    const totalPrice = items.reduce((sum, item) => sum + Number(item.price_cny), 0);
        ...
        <>
            <div className="px-5 mt-7 mb-21">
                ...
                {loading ? (
                    ...
                    items.map((item) => ( 
                        <div key={item.id} className="mt-3 flex flex-row justify-between border border-gray-300 rounded-lg h-22">
                            <div>
                                <div className="flex flex-row items-center">
                                    ...
                                    <div className="flex-col ml-2.5">
                                        <p className="text-sm truncate w-[160px] h-[1.2em] whitespace-nowrap overflow-hidden">{item.url}</p>
