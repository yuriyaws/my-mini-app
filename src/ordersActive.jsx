    ...
    return(
        <>
            ...
            {loading ? (
                    ...
                    orders.map((order) => (
                        <div key={order.id} className="mt-3 flex flex-col border border-gray-300 rounded-lg h-full px-2.5 py-2 gap-1.5">
                            ...
                            {order.paid ? (
                                ...
                                <div>
                                    <button className='px-2 py-1 bg-blue-500 rounded-md text-xs text-white font-medium'>Оплатить заказ</button>
                                </div>
                            )
                            }
                            ...
                            <div key={oi.id} className="flex items-center gap-2 border border-gray-300 p-2 rounded-md bg-gray-50">
                                <img
