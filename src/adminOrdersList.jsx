...
const AdminOrdersList = ({ setAdminPage, setSelectedOrder }) => {
  ...
  const handleOrderClick = (order) => {
    ...
    setAdminPage("adminOrderInfo");
  };

  return (
    <div className="px-5 mt-36 mb-21">
      <div className="fixed w-full top-0 left-0 px-5 pt-7 bg-white border-b border-gray-200">
