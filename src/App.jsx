    ...
    <>
      <div className='fixed bottom-0 bg-white border-t border-gray-300 w-full h-14 z-10 flex flex-row justify-between px-10'>
        ...
        >
          ...
          <p className={`text-xs ${page === 'home' ? 'text-blue-600' : 'text-gray-500'}`}>Главная</p>
        </button>
        ...
        >
          ...
          <p className={`text-xs ${page === 'add' ? 'text-blue-600' : 'text-gray-500'}`}>Добавить</p>
        </button>
        ...
        >
          ...
          <p className={`text-xs ${page === 'cart' ? 'text-blue-600' : 'text-gray-500'}`}>Корзина</p>
        </button>
        ...
        >
          ...
          <p className={`text-xs ${page === 'orders' ? 'text-blue-600' : 'text-gray-500'}`}>Заказы</p>
        </button>
      </div>
