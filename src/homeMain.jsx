    ...
    return(
        <>
            ...
            <div className='flex flex-col gap-10 mt-16 mb-21'>
                ...
                <img src='/public/aycdLogo.jpg' className='h-25 w-25 rounded-3xl'></img>
                <h1 className='text-xl font-bold'>AYCD</h1>
                <p className='text-sm text-gray-500'>Быстрая доставка товаров из Китая в Россию</p>
                </div>
                ...
                >
                    ...
                    <div className="-mt-2">
                        <h3 className="text-lg font-bold text-gray-900">Выберите товар</h3>
                    ...
                    <div className="-mt-2">
                        <h3 className="text-lg font-bold text-gray-900">Оплатите товар</h3>
                    ...
                    <div className="-mt-2">
                        <h3 className="text-lg font-bold text-gray-900">Получите товар</h3>
                ...
                <p className='text-sm text-gray-500'>Есть вопросы? <a className='text-blue-500 underline'>Свяжитесь с нами</a></p>
                </div>
            </div>
